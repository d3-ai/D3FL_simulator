...
def sample():
    ...
    client_fn_origin = client_fn(trainloaders, valloaders, DEVICE)
    # Start simulation
    fl.simulation.start_simulation(
        client_fn=client_fn_origin,
...
def client_fn(trainloaders, valloaders, DEVICE: str = 'cpu') :
    """Create a Flower client representing a single organization."""
    def client_fn_origin(cid: str):
